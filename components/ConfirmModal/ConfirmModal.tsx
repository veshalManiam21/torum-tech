...
export type ConfirmModalProps = {
  ...
  customLinkNameConfirm?: string;
  customLinkNameCancel?: string;
...
export const ConfirmModal: React.FC<ConfirmModalProps> = ({
  ...
  onCancel,
  isConfirming,
  customLinkNameConfirm = "confirm",
  customLinkNameCancel = "cancel",
  trackConfirmCtaClick = true,
}) => {
  return (
    <div className="flex flex-col items-center max-w-lg p-4 overflow-y-auto bg-white rounded-lg lg:p-6">
